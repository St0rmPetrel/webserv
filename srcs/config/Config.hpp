...
namespace config {
	...
	private:
		// todo: find better name for this method
			...
			Module					_collect_module(const std::vector<std::string>& name, const std::vector<std::string>& tokens, std::vector<std::string>::const_iterator& it, bool is_global) const;
